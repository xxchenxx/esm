...
def run(args):
    ...
    for batch_idx, (labels, strs, toks, _, _) in enumerate(data_loader):
            ...
            outputs = decoder.generate(encoder_hidden_states=out["representations"][repr_layers[-1]], num_beams=3, num_return_sequences=num_return_sequences, top_k=5, max_length=50, repetition_penalty=3, top_p=0.9, temperature=1.5)
            ...
            print('Output: {}'.format(tokenizer.decode(outputs[0][0], skip_special_tokens=True)))    
            print('\n')
