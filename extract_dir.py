...
from esm import Alphabet, FastaBatchedDataset, ProteinBertModel, pretrained, FireprotDirBatchedDataset
...
def main(args):
    ...
    dataset = FireprotDirBatchedDataset.from_file(args.fasta_file)
